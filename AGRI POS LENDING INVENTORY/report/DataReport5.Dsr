...
With Me.Sections("Section2").Controls
    .Item("Label4").Caption = frmPaymentforbalance.Text5.Text
    .Item("Label5").Caption = frmPaymentforbalance.Text6.Text
    .Item("Label7").Caption = frmPaymentforbalance.Text7.Text
End With
End Sub
